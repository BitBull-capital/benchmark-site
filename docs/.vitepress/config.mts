...
export default defineConfig({
  ...
  head: [
    ['link', {
      rel: 'icon',
      href: 'https://raw.githubusercontent.com/BitBull-capital/benchmark-site/master/public/images/robot.svg'
    }]
  ],
  themeConfig: {
    logo: 'https://raw.githubusercontent.com/BitBull-capital/benchmark-site/master/public/images/robot.svg',

    nav: [
      { text: 'Benchmarks', link: '/' },
    ],
